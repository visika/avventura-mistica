...
nome = raw_input(prompt)

print "Una bellissima fanciulla!\n"

print "Entri in una stanza oscura con cinque porte. Attraversi la porta n°1 o la porta n°2 o la porta n°3 o la porta n°4 o la porta n°5?"

porta = raw_input(prompt)
...
if porta == "1":
    ...
    print "Ti trovi al cospetto dell'occhio di Sauron. Sauron ti chiede di offrirgli l'anello del potere. Che fai?"
    ...
    print """Ti addentri in un luogo non ben definito, avvolto da una nebbia di un color verde ocra.
